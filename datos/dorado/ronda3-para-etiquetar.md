# Ronda 3 — 20 menciones nuevas

Valida la corrección del criterio de fallas que salió de la ronda 2.
Ninguna de estas apareció en el set dorado ni en la ronda 2.

Escribí `positivo`, `neutro` o `negativo` en cada `SENTIMIENTO:`.

## Los criterios, ya corregidos

1. **Fallas — depende del momento.** La falla *en curso* (sufrirla, reclamarla,
   preguntar si están caídos, burlarse) es **negativo**. La falla *ya resuelta*
   —un parte que dice que el servicio volvió, que no hubo pérdida de datos— es
   **neutro**, o positivo si destaca que se resolvió bien.
2. **Cupones, promos y códigos de descuento** son **neutros**.
3. **Noticias donde nadie evalúa al objetivo** son **neutras**, sea el contexto
   favorable o desfavorable.

En todo lo demás: ¿esto deja bien, mal o indiferente al objetivo ante quien lo lea?
